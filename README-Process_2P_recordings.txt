Step 0:
0) Run Suite2p (concatenated across all stimuli recorded in one session) 

Get all the session information.
...
common to all stimuli: Wheel, PD, Quad, 2P. Saves as a new .m file for each 
stimulus  
