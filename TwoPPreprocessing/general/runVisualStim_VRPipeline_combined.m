...
logFilePath = fullfile('Z:\ibn-vision\USERS\Sonali\errorLogs', 'runNewVRCorr_VisualStimPipeline_20260127.csv');
        ...
        try
            ...
            if ~isempty(otherVisualStim)
                ...
                if ~isempty(snIdx)
                    ...
                    [~, sessionFileInfo] = get2PFramesByTrial(sessionFileInfo, thisSNName); %Defaults for sparseNoise have been set tp 0 prestim and 0.7 post stim 
                    analyseSparseNoise(sessionFileInfo);
                else
