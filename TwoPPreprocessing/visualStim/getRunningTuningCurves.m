function [response] = getRunningTuningCurves(signalMatrix, wheelValue, wheelSampleTimes, options)
...
wheelSpeed = [0; diff(wheelValue * tickToCm)] ./ [1; diff(wheelSampleTimes)];
