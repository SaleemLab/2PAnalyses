function [bonsaiData] = Copy_of_getSparseNoiseBonsaiFiles(sessionFileInfo, gridSize)
    ...
    for iStim = 1:length(sessionFileInfo.stimFiles)
        bonsaiData.isSparseNoise(iStim) = strcmp('SparseNoiseTexture',sessionFileInfo.stimFiles(iStim).name);
    end
