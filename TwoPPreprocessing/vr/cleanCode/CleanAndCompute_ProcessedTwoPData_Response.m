...
logFilePath = "Z:\ibn-vision\USERS\Sonali\errorLogs\unprocessed_log20251105.csv";
...
filteredTable = filterMasterTable('Exclude', 0, 'Suite2PPreprocessing', 1, 'TargetArea', {'RSP', 'ENTm'}, ...
    'HasStimulus', 'VRCorr');
