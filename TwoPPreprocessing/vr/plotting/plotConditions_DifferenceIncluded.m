...
% Row 3: Mean Delta Change Line Plots (5 Columns)
% Squeezed layout dimensions to match thin, vertically elongated subplots.
    ...
    row1_Positions = {[0.08, 0.64, 0.11, 0.28], [0.21, 0.64, 0.11, 0.28], [0.34, 0.64, 0.11, 0.28], [0.47, 0.64, 0.11, 0.28], [0.60, 0.64, 0.11, 0.28], [0.73, 0.64, 0.11, 0.28]}; % 6 Absolute Columns
    row2_Positions = {[0.21, 0.28, 0.11, 0.28], [0.34, 0.28, 0.11, 0.28], [0.47, 0.28, 0.11, 0.28], [0.60, 0.28, 0.11, 0.28], [0.73, 0.28, 0.11, 0.28]};                         % 5 Delta Columns (same height/width as Row 1)
    row3_Positions = {[0.21, 0.06, 0.11, 0.14], [0.34, 0.06, 0.11, 0.14], [0.47, 0.06, 0.11, 0.14], [0.60, 0.06, 0.11, 0.14], [0.73, 0.06, 0.11, 0.14]};                         % 5 Mean Delta Line Columns
    ...
    for i = 1:5
        ...
        set(axMean, 'YLim', [-0.2, 0.3], 'YLimMode', 'manual');
