function plotSingleROIHeatmaps_AllROIs_SortedByRunningSpeed(sessionFileInfo, response, applySmoothing)
...
%% Find mean running speed across laps 
...
for roiIdx = 1:nROIs
    ...
    % Save figure
    figName = sprintf('%s_%s_ROI%d_dFFNeuropilCorrected_SortedByRunningSpeed.pdf', ...
