function [bonsaiData, sessionFileInfo] = findBonsaiPeripheralLag(sessionFileInfo, VRStimName, method, samplingRate, plotFlag)
...
%
% Usage Example:
%   [bonsaiData] = findBonsaiPeripheralLag(sessionFileInfo, VRStimName, 1, 60)
%
% Originally Sam's code :) Edited Masa and Diao's version - Sonali March 2025
