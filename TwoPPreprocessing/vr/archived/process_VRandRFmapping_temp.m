...
%      };
     ...
     'M25058', {'20250526'}, {'M25058_VRCorr_20250526_00001',...
                            'M25058_VRCorr_20250526_00002',...
                          'M25058_VRCorr_20250526_00004',...
                          'M25058_RFMapping_20250526_00001',...
                          'M25058_GrayScreen_20250526_00001',...
     };
...
%         if strcmp(mousenumber, 'M25040') || strcmp(mousenumber, 'M25037')
        ...
        try
            ...
            for thisVRStim = 1:length(vrStimNames)
                ...
                %Add another function here to load processedTwoPData and compute dFF, dFFNeuropilCorrection and fNeuropilCorrection 
                % [processedTwoPData, sessionFileInfo] = computeNeuropilCorrectionAndDFF(sessionFileInfo, stimName, applyTemporalSmoothing, prctl_F, window_size)
                ...
                [response, sessionFileInfo] = getLapPositionActivityV2(sessionFileInfo, 'F', true, vrStimName , false, true, true); %used V2 for all sessions prior to PIPS
