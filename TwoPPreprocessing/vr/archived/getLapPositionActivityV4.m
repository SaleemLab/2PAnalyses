function [response, sessionFileInfo] = getLapPositionActivityOLD(sessionFileInfo, VRStimName, applySmoothing, onlyIncludeROIs)
...
%% Load required data
if exist(sessionFileInfo.stimFiles(stimIdx).processedMergedBonsaiSuite2pData, 'file') && ...
   exist(sessionFileInfo.stimFiles(stimIdx).Response, 'file')
