...
if ~overwrite && ~isempty(existingStimIndex) && exist(combinedResponseFilePath, 'file')
    ...
    % Load the flattened file back into a struct for the output
...
% CRITICAL CHANGE: Use '-struct' to save fields as individual variables.
% This keeps the combined file consistent with your single-run files.
