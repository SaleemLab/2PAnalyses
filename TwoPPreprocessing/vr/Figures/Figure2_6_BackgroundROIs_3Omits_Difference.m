...
%plotBackgroundROIs_DifferenceOnly
plotBackgroundROIs_DifferenceOnly(VISpDataSpks, 'V1', ...
    'TypeToPlot', 'Somas', ...
    'RequiredConditions', { 'Omit_2', 'Omit_3', 'Omit_4'},  ... %'Swap_2_3', 'Swap_3_4',
    'SavePath', 'Z:\ibn-vision\USERS\Sonali\Figures\ThesisFigs\ResultsChapter1-VISpSomas\Fig2_6_Section3\pooledBackgroundROIs_omitconditions_withDiff\pooledBackgroundROIs_omitconditions_withDiff');

plotPeriodicROIs_DifferenceOnly(VISpDataSpks, 'V1', ...
    'TypeToPlot', 'Somas', ...
    'RequiredConditions', { 'Omit_2', 'Omit_3', 'Omit_4'},  ... %'Swap_2_3', 'Swap_3_4',
    'SavePath', 'Z:\ibn-vision\USERS\Sonali\Figures\ThesisFigs\ResultsChapter1-VISpSomas\Fig2_6_Section3\pooledBackgroundROIs_omitconditions_withDiff\pooledBackgroundROIs_omitconditions_withDiff');
