...
# module folder_defs.This saves all the necessary root directories; currently still in Schoiner 
...
# Edit the preprocess_test.csv to make changes to this 
...
for i in range(len(database)):
    ...
    if database.loc[i]["Process"]:
        try:
            ...
            (
                s2pDirectory,
                zstackPath, # path to file
                metadataDirectory, # dir that contains the nidaq bin and channel csv 
                saveDirectory,
            ...
            # is at least 1-dimensional. This would be used if fly-back planes were saved.. 
            ...
            # Returns the ops dictionary from the first plane/combined subfolder
